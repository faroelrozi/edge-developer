...
description: Use the Microsoft Edge DevTools Timeline panel to record and analyze  all the activity in your application as it runs. It's the best place to start  investigating perceived performance issues in your application.
...
Use the Microsoft Edge DevTools <em>Timeline</em> panel to record 
...
* **Disable extensions**. Microsoft Edge extensions can add unrelated noise to 
  Timeline recordings of your application. Open a Microsoft Edge window in 
  [inPrivate mode][inPrivate], or create a new 
  [Microsoft Edge user profile][new chrome profile] to ensure that your environment
  has no extensions.
...
[event reference]: /microsoft-edge/devtools-guide-chromium/chromium-devtools/profile/evaluate-performance/performance-reference
