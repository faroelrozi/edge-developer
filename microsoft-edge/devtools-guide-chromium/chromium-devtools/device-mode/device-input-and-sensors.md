...
description: Touch screens, GPS chips, and accelerometers can be difficult to test since most desktops don't have them. The Microsoft Edge DevTools sensor emulators reduce the overhead of testing by emulating common mobile device sensors.
robots: noindex
...
GPS chips and accelerometers can be difficult to test since most desktops don't have them. The Microsoft Edge DevTools Sensors emulation pane reduces the overhead of testing by emulating common mobile device sensors.
...
<div class="wf-devtools-flex">
  <div>
    <p>To access the Microsoft Edge DevTools sensor controls:</p>
    <ol>
  ...
  <div class="wf-devtools-flex-half">
    <img src="imgs/navigate-to-sensors.msft.png" alt="Navigate to Sensors panel">
  </div>
</div>
...
<aside class="warning">
  <b>This page is deprecated</b>. See <a href="/microsoft-edge/devtools-guide-chromium/chromium-devtools/device-mode/geolocation">Override Geolocation</a>.
</aside>
...
<div class="wf-devtools-flex">
  ...
  <div class="wf-devtools-flex-half">
    <img src="imgs/emulation-drawer-geolocation.msft.png" alt="geolocation emulator enabled">
  </div>
</div>
...
<aside class="warning">
  <b>This page is deprecated</b>. See <a href="/microsoft-edge/devtools-guide-chromium/chromium-devtools/device-mode/orientation">Simulate Device Orientation</a>.
</aside>
...
<div class="wf-devtools-flex">
  ...
  <div class="wf-devtools-flex-half">
    <img src="imgs/emulation-drawer-accelerometer.msft.png" alt="Accelerometer control">
  </div>
</div>
