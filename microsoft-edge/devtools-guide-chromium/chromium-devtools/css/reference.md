...
Discover new workflows in this comprehensive reference of Microsoft Edge DevTools
features related to viewing and changing CSS.

See [Get Started with Viewing and Changing CSS][GS] to learn the basics.

[GS]: /microsoft-edge/devtools-guide-chromium/chromium-devtools/css/
...
[Tutorial]: /microsoft-edge/devtools-guide-chromium/chromium-devtools/css/#view

<figure>
  <img src="imgs/select.msft.png"
...
[format]: /microsoft-edge/devtools-guide-chromium/chromium-devtools/javascript/reference#format

<figure>
  <img src="imgs/view-rule-stylesheet.msft.svg"
...
<figure>
  <img src="imgs/computed.msft.svg"
...
<figure>
  <img src="imgs/box-model.msft.png" alt="The Box Model diagram"/>
  <figcaption>
...
<figure>
  <img src="imgs/styles-filter.msft.png" alt="Filtering the Styles tab"/>
  <figcaption>
...
<figure>
  <img src="imgs/computed-filter.msft.png" alt="Filtering the Computed tab"/>
  <figcaption>
...
<figure>
  <img src="imgs/pseudo-class.msft.png" alt="Toggling the :hover pseudo-class"/>
  <figcaption>
...
[pseudo-tutorial]: /microsoft-edge/devtools-guide-chromium/chromium-devtools/css/#pseudostates

### View a page in print mode {: #print-mode }

To view a page in print mode:

1. Open the [Command Menu](/microsoft-edge/devtools-guide-chromium/chromium-devtools/ui#command-menu).
...
1. Press <kbd>Command</kbd>+<kbd>Shift</kbd>+<kbd>P</kbd> (Mac) or
   <kbd>Control</kbd>+<kbd>Shift</kbd>+<kbd>P</kbd> (Windows, Linux, Microsoft Edge OS)
...
1. Start typing `coverage` and select **Show Coverage**. The Coverage tab appears.
     ...
     <figure>
       <img src="imgs/command-menu.msft.png"
     ...
     <figure>
       <img src="imgs/coverage-empty.msft.png"
...
1. Click **Start Instrumenting Coverage And Reload Page** ![Start Instrumenting Coverage
   ...
   browser loads. Green represents used CSS. Red represents unused CSS.
     ...
     <figure>
       <img src="imgs/coverage-overview.msft.png"
...
1. Click a CSS file to see a line-by-line breakdown of what CSS it uses.
     ...
     <figure>
       <img src="imgs/coverage-detail.msft.png"
...
See [Force DevTools Into Print Preview Mode](/microsoft-edge/devtools-guide-chromium/chromium-devtools/css/print-preview).
...
<figure>
  <img src="imgs/inline-declaration.msft.png" alt="Adding inline declarations"/>
  <figcaption>
...
<figure>
  <img src="imgs/add-declaration-existing-rule.msft.png"
...
<figure>
  <img src="imgs/element-classes.msft.svg" alt="The Element Classes pane"/>
  <figcaption>
...
<figure>
  <img src="imgs/style-rule.msft.png" alt="Adding a new style rule"/>
  <figcaption>
...
<figure>
  <img src="imgs/choose-stylesheet.msft.png" alt="Choosing a stylesheet"/>
  <figcaption>
...
<figure>
  <img src="imgs/insert-style-rule-below.msft.png" alt="Insert Style Rule Below"/>
  <figcaption>
...
1. In the **Styles** tab, hover over a style rule. **More Actions**
   ...
   style rule's section.
     ...
     <figure>
       <img src="imgs/reveal-more.msft.png" alt="Revealing \"More\" Actions"/>
       <figcaption>
...
1. Hover over **More Actions** ![More](imgs/more.png){:.cdt-inl} to reveal
   the actions mentioned above.
     ...
     <figure>
       <img src="imgs/insert-style-rule-below.msft.png"
...
<figure>
  <img src="imgs/toggle-declaration.msft.png" alt="Toggling a declaration"/>
  <figcaption>
...
<figure>
  <img src="imgs/add-background-color.msft.png" alt="Add Background Color"/>
  <figcaption>
...
<figure>
  <img src="imgs/add-color.msft.png" alt="Add Color"/>
  <figcaption>
...
<figure>
  <img src="imgs/add-box-shadow.msft.png" alt="Add Box Shadow"/>
  <figcaption>
...
<figure>
  <img src="imgs/add-text-shadow.msft.png" alt="Add Text Shadow"/>
  <figcaption>
...
1. In the **Styles** tab, find the `color` or `background-color` declaration
   ...
   value, there is a small square which is a preview of the color.
     ...
     <figure>
       <img src="imgs/color-preview.msft.png" alt="Color preview"/>
       <figcaption>
...
1. Click the preview to open the **Color Picker**.
     ...
     <figure>
       <img src="imgs/color-picker.msft.png" alt="The Color Picker"/>
       <figcaption>
...
<figure>
  <img src="imgs/color-picker-annotated.msft.svg"
...
1. Click to confirm.
     ...
     <figure>
       <img src="imgs/eyedropper.msft.png" alt="Using the Eyedropper"/>
       <figcaption>
