...
Learn how to use Microsoft Edge and DevTools to find memory issues
...
[RAIL]: /microsoft-edge/devtools-guide-chromium/chromium-devtools/profile/evaluate-performance/rail

## Monitor memory use in realtime with the Microsoft Edge Task Manager

Use the Microsoft Edge Task Manager as a starting point to your memory issue
...
1. Press <kbd>Shift</kbd>+<kbd>Esc</kbd> or go to
   the Microsoft Edge main menu and select **More tools** > **Task manager** to open
   the Task Manager.
...
[recording]: /microsoft-edge/devtools-guide-chromium/chromium-devtools/profile/evaluate-performance/timeline-tool#make-a-recording
...
You can use either the Microsoft Edge Task Manager or Timeline memory recordings to
