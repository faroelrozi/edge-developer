...
description: Measure the network performance of your web application using the Microsoft Edge DevTools Network panel.
...
* **Initiator**. The object or process that initiated the request. It can
  ...
  * **Parser**. Microsoft Edge's HTML parser initiated the request.
...
[nc]: /microsoft-edge/devtools-guide-chromium/chromium-devtools/profile/network-performance/network-conditions#network-conditions
...
* [High Performance Networking in Microsoft
  Microsoft Edge](https://www.igvita.com/posa/high-performance-networking-in-google-chrome/)
  discusses Microsoft Edge network internals and how you can take advantage of them
