...
# Optimize Website Speed With Microsoft Edge DevTools {: .page-title }

{% include "web/_shared/contributors/kaycebasques.html" %}

## Goal of tutorial

This tutorial teaches you how to use Microsoft Edge DevTools to find ways to make your websites
load faster.
...
<figure>
  <img src="imgs/tony.msft.jpg" alt="Tony the cat."/>
  <figcaption>
...
1. Go to `edge://version` to check what version of Microsoft Edge you're using. This tutorial was made
   with Microsoft Edge 68. If you're using an earlier or later version, some features may look different
...
1. <a class="external gc-analytics-event" href="https://glitch.com/edit/#!/tony" target="_blank"
   ...
   source code for the site</a>. This tab will be referred to as the *editor tab*.
     ...
     <figure>
       <img src="imgs/editor.msft.png" alt="The editor tab."/>
       <figcaption>
...
1. Click **tony**. A menu appears.
     ...
     <figure>
       <img src="imgs/menu.msft.png" alt="The menu that appears after clicking 'tony'."/>
       <figcaption>
...
1. Click **Show Live**. The demo opens in a new tab. This tab will be referred to as the *demo
   tab*. It may take a while for the site to load.
     ...
     <figure>
       <img src="imgs/demo.msft.png" alt="The demo tab."/>
       <figcaption>
...
1. Press <kbd>Command</kbd>+<kbd>Option</kbd>+<kbd>J</kbd> (Mac)
   <kbd>Control</kbd>+<kbd>Shift</kbd>+<kbd>J</kbd> (Windows, Linux, Microsoft Edge OS). Microsoft Edge DevTools
   opens up alongside the demo.

     <figure>
       <img src="imgs/devtools.msft.png" alt="DevTools and the demo."/>
       <figcaption>
...
<kbd>Control</kbd>+<kbd>Shift</kbd>+<kbd>P</kbd> (Windows, Linux, Microsoft Edge OS) to open the Command
Menu, typing `Undock`, and then selecting **Undock into separate window**.

<figure>
  <img src="imgs/undocked.msft.png" alt="Undocked DevTools."/>
  <figcaption>
...
1. Click the **Audits** tab. It may be hidden behind the **More Panels**
   ...
   [Lighthouse](/web/tools/lighthouse).
     ...
     <figure>
       <img src="imgs/audits.msft.png" alt="The Audits panel."/>
       <figcaption>
...
1. Click **Run Audits**. After 10 to 30 seconds, the Audits panel shows you a report of the site's
   performance.
     ...
     <figure>
       <img src="imgs/report.msft.png" alt="An Audits panel report of the site's performance."/>
       <figcaption>
...
[inPrivate window][inPrivate]{:.external} with no other tabs open. This ensures that
you're running Microsoft Edge from a clean state. Microsoft Edge Extensions in particular often interfere
with the auditing process.

<figure>
  <img src="imgs/error.msft.png" alt="A report that errored."/>
  <figcaption>
...
<figure>
  <img src="imgs/overall.msft.png" alt="The overall performance score."/>
  <figcaption>
...
<figure>
  <img src="imgs/metrics.msft.png" alt="The Metrics section."/>
  <figcaption>
...
<figure>
  <img src="imgs/fmp.msft.png" alt="Hovering over the First Meaningful Paint metric."/>
  <figcaption>
...
<figure>
  <img src="imgs/screenshots.msft.png" alt="Screenshots of how the page looked while loading."/>
  <figcaption>
...
<figure>
  <img src="imgs/opportunities.msft.png" alt="The Opportunities section."/>
  <figcaption>
...
<figure>
  <img src="imgs/compression.msft.png" alt="More information about the text compression opportunity."/>
  <figcaption>
...
<figure>
  <img src="imgs/reference.msft.png" alt="Documentation for the text compression opportunity."/>
  <figcaption>
...
<figure>
  <img src="imgs/diagnostics.msft.png" alt="The Diagnostics section"/>
  <figcaption>
...
<figure>
  <img src="imgs/passed.msft.png" alt="The Passed Audits section."/>
  <figcaption>
...
1. Click **Use Large Request Rows** ![Use Large Request Rows][large]{: .inline-icon }. The
   height of the rows in the table of network requests increases.
     ...
     <figure>
       <img src="imgs/largerows.msft.png" alt="Large rows in the network requests table."/>
       <figcaption>
         <b>Figure 20</b>. Large rows in the network requests table
       </figcaption>
     </figure>

[large]: /microsoft-edge/devtools-guide-chromium/chromium-devtools/network-performance/imgs/large-resource-rows-button.png
...
1. Click the **Headers** tab.
     ...
     <figure>
       <img src="imgs/headers.msft.png" alt="The Headers tab."/>
       <figcaption>
...
1. In the editor tab, click **server.js**.
     ...
     <figure>
       <img src="imgs/server.msft.png" alt="Editing server.js."/>
       <figcaption>
...
1. Wait for Glitch to deploy the new build of the site. The fancy animation that you see next
   ...
   The change is ready when you see **Show Live** again.
     ...
     <figure>
       <img src="imgs/building.msft.png" 
...
1. Go back to the demo tab and reload the page. The **Size** column should now show 2 different
   ...
   `1.4 MB` is the uncompressed file size.
     ...
     <figure>
       <img src="imgs/requests.msft.png" 
...
1. Press <kbd>Command</kbd>+<kbd>Shift</kbd>+<kbd>P</kbd> (Mac) or
   ...
   the Command Menu, start typing `Coverage`, and then select **Show Coverage**.
     ...
     <figure>
       <img src="imgs/coverage.msft.png" 
...
1. Click **Reload** ![Reload](imgs/reload.png){: .inline-icon }. The Coverage tab provides an
   ...
   Lodash files aren't used, respectively.
     ...
     <figure>
       <img src="imgs/coveragereport.msft.png" 
...
1. Click the **Network** tab.
1. Press <kbd>Command</kbd>+<kbd>Shift</kbd>+<kbd>P</kbd> (Mac) or
   <kbd>Control</kbd>+<kbd>Shift</kbd>+<kbd>P</kbd> (Windows, Linux, Microsoft Edge OS) to open the
   Command Menu again.
1. Start typing `blocking` and then select **Show Request Blocking**.

     <figure>
       <img src="imgs/blocking.msft.png" 
...
1. Reload the page. The jQuery and Lodash requests are red, meaning that they were blocked.
   ...
   whatsoever!
     ...
     <figure>
       <img src="imgs/blockedlibs.msft.png" 
...
1. Click **Reload** ![Reload](imgs/reload.png){:.inline-icon}. DevTools reloads the page and
   ...
   This visualization will be referred to as the *trace*.
     ...
     <figure>
       <img src="imgs/performance.msft.png" 
...
<figure>
  <img src="imgs/overview.msft.png" 
...
1. Click the **User Timing** section to expand it. Based on the fact that there seems to be a
   ...
   yield some easy performance wins.
     ...
     <figure>
       <img src="imgs/usertiming.msft.png" 
...
1. Expand the **Bottom-Up** section. This tab breaks down what activities took up the most time.
   ...
   the Bottom-Up section is only going to show information for that one activity.
     ...
     <figure>
       <img src="imgs/bottomup.msft.png" 
...
[reference]: /microsoft-edge/devtools-guide-chromium/chromium-devtools/evaluate-performance/reference
...
<script>
var label = '/microsoft-edge/devtools-guide-chromium/chromium-devtools/speed/get-started';
var feedback = {
  "category": "Gift",
  "choices": [
    {
...
* Tweet us at [@EdgeDevTools](https://twitter.com/chromedevtools).

[ML]: https://groups.google.com/forum/#!forum/google-chrome-developer-tools
[WF]: https://github.com/google/webfundamentals/issues/new
[SO]: https://stackoverflow.com/questions/tagged/google-chromium-devtools
