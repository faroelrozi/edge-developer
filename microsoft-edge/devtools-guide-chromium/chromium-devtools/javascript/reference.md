...
Discover new debugging workflows with this comprehensive reference of Microsoft Edge
DevTools debugging features.

See [Get Started With Debugging JavaScript In Microsoft Edge
DevTools](/microsoft-edge/devtools-guide-chromium/chromium-devtools/javascript) to learn the basics of
debugging.
...
<figure>
  <img src="imgs/step-over-outline.msft.svg"
...
<figure>
  <img src="imgs/step-into-outline.msft.svg"
...
<figure>
  <img src="imgs/step-out-outline.msft.svg"
...
<figure>
  <img src="imgs/continue-to-here.msft.png" alt="Selecting 'Continue to here'."/>
  <figcaption>
...
<figure>
  <img src="imgs/restart-frame.msft.png"
...
<figure>
  <img src="imgs/resume-script-execution-outline.msft.svg"
...
<figure>
  <img src="imgs/selecting-force-script-execution.msft.png"
...
<figure>
  <img src="imgs/threads.msft.svg" alt="The Threads pane."/>
  <figcaption>
...
<figure>
  <img src="imgs/scope.msft.svg" alt="The Scope pane."/>
  <figcaption>
...
<figure>
  <img src="imgs/call-stack.msft.svg"
...
<figure>
  <img src="imgs/copy-stack-trace.msft.png"
...
<figure>
  <img src="imgs/blackbox-editor-pane.msft.png"
...
<figure>
  <img src="imgs/blackbox-call-stack-pane.msft.png"
...
<figure>
  <img src="imgs/blackbox.msft.png"
...
Page](/microsoft-edge/devtools-guide-chromium/chromium-devtools/snippets) to learn more.
...
1. Press <kbd>Command</kbd>+<kbd>S</kbd> (Mac) or
   ...
   the entire JS file into Microsoft Edge's JavaScript engine.

 <figure>
   <img src="imgs/editor.msft.svg"
     alt="The Editor pane."/>
...
See [Disable JavaScript With Microsoft Edge DevTools](/microsoft-edge/devtools-guide-chromium/chromium-devtools/javascript/disable).
