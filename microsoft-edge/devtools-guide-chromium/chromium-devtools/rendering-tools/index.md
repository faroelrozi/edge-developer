...
* [Diagnose Forced Synchronous
  Layouts](/microsoft-edge/devtools-guide-chromium/chromium-devtools/rendering-tools/forced-synchronous-layouts)


### Tools

The Microsoft Edge DevTools **Timeline** identifies when a page causes forced
