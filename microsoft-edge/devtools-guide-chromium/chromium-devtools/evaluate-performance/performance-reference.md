...
|----------|:-----------------------------------------------------------------|
| Aggregated time | For events with [nested events](/microsoft-edge/devtools-guide-chromium/chromium-devtools/profile/evaluate-performance/timeline-tool#view-nested-events), the time taken by each category of events.|
| Call Stack | For events with [child events](/microsoft-edge/devtools-guide-chromium/chromium-devtools/profile/evaluate-performance/timeline-tool#view-nested-events), the time taken by each category of events.|
...
| Event | Description |
|-------|:----------|
|Parse HTML|  Microsoft Edge executed its HTML parsing algorithm.|
...
|Time|  A script called [console.time()](/microsoft-edge/devtools-guide-chromium/chromium-devtools/debug/console/console-reference#consoletimelabel)|
|Time End|  A script called [console.timeEnd()](/microsoft-edge/devtools-guide-chromium/chromium-devtools/debug/console/console-reference#consoletimeendlabel)|
...
| Event | Description |
|-------|:----------|
|Composite Layers|  Microsoft Edge's rendering engine composited image layers.|
