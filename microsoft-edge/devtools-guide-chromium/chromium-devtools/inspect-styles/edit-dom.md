...
description: The DOM tree view in the Microsoft Edge DevTools Elements panel displays the DOM structure of the current web page. Live-edit the content and structure of your page through DOM updates.
...
The DOM tree view in the Microsoft Edge DevTools Elements panel displays the DOM structure of the current web page. Live-edit the content and structure of your page through DOM updates.
...
![Inspect an element via right-click](/microsoft-edge/devtools-guide-chromium/chromium-devtools/inspect-styles/imgs/right-click-inspect.png)
...
![Inspect icon](/microsoft-edge/devtools-guide-chromium/chromium-devtools/inspect-styles/imgs/inspect-icon.png){:.inline}
...
[currentSrc console]: /microsoft-edge/devtools-guide-chromium/chromium-devtools/inspect-styles/imgs/currentSrc-console.png
...
[currentSrc properties]: /microsoft-edge/devtools-guide-chromium/chromium-devtools/inspect-styles/imgs/currentSrc-properties.png
...
Note: Many Microsoft Edge extensions add their own event listeners onto the DOM. If you see a number of event listeners that aren't set by your code, you may want to reopen your page in an [Incognito window](https://support.google.com/chrome/answer/95464). Incognito windows prevent extensions from running by default.
...
[inspect]: /microsoft-edge/devtools-guide-chromium/chromium-devtools/debug/command-line/command-line-reference#inspect

## Show HTML comments {: #show-html-comments }

To show or hide HTML comments in the Elements panel:

1. Open [Settings](/microsoft-edge/devtools-guide-chromium/chromium-devtools/ui#settings).
