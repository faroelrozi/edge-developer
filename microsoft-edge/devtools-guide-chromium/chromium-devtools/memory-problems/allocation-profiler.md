...
[heap profiler](/microsoft-edge/devtools-guide-chromium/chromium-devtools/profile/memory-problems/heap-snapshots)
with the incremental updating and tracking of the
[Timeline panel](/microsoft-edge/devtools-guide-chromium/chromium-devtools/profile/evaluate-performance/timeline-tool).
...
1. Make sure you have the latest [Microsoft Edge Canary](https://www.google.com/intl/en/chrome/browser/canary.html).
