...
description: Learn how to use Microsoft Edge DevTools to view and change a page's CSS.
...
changing a page's CSS using Microsoft Edge DevTools.
...
1. Enter the value in the text box below.
     ...
     {% include "microsoft-edge/devtools-guide-chromium/chromium-devtools/css/_data-message.html" %}
...
1. The `aloha` class is declaring a value for `padding`. Enter that value
   in the text box below.
     ...
     {% include "microsoft-edge/devtools-guide-chromium/chromium-devtools/css/_padding.html" %}
...
you see in **Figure 1**, see [Change DevTools placement](/microsoft-edge/devtools-guide-chromium/chromium-devtools/ui#placement).

<figure>
  <img src="imgs/aloha.msft.png"
...
1. Right-click the `Add A Background Color To Me!` text below and select
   **Inspect**.
     ...
     {% include "microsoft-edge/devtools-guide-chromium/chromium-devtools/css/_background-color.html" %}
...
<figure>
  <img src="imgs/declaration.msft.png"
...
1. Right-click the `Add A Class To Me!` element below and select **Inspect**.
     ...
     {% include "microsoft-edge/devtools-guide-chromium/chromium-devtools/css/_class.html" %}
...
<figure>
  <img src="imgs/apply-class.msft.png"
...
<figure>
  <img src="imgs/set-hover.msft.png"
...
1. Right-click the `Change My Margin!` element below and select **Inspect**.
     ...
     {% include "microsoft-edge/devtools-guide-chromium/chromium-devtools/css/_margin.html" %}
...
<figure>
  <img src="imgs/show-padding.msft.png"
...
<figure>
  <img src="imgs/change-margin.msft.png"
