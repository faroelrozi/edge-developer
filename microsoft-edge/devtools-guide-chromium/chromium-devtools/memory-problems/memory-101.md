...
[Microsoft Edge DevTools Heap Profiler](/microsoft-edge/devtools-guide-chromium/chromium-devtools/profile/memory-problems/heap-snapshots).
...
Learn [how to record a profile using the Heap Profiler](/microsoft-edge/devtools-guide-chromium/chromium-devtools/profile/memory-problems/heap-snapshots).
