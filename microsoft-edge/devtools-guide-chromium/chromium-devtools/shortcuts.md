...
# Microsoft Edge DevTools Keyboard Shortcuts {: .page-title }
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Switch back to whatever <a href="/microsoft-edge/devtools-guide-chromium/chromium-devtools/ui#placement">docking position</a> you last used.
    ...
    <tr>
      <td>Toggle <b><a href="/microsoft-edge/devtools-guide-chromium/chromium-devtools/device-mode/">Device Mode</a><b></td>
    ...
    <tr>
      <td>Open the <b><a href="/microsoft-edge/devtools-guide-chromium/chromium-devtools/ui#command-menu">Command Menu</a></b></td>
      <td><kbd>Command</kbd>+<kbd>Shift</kbd>+<kbd>P</kbd></td>
      <td><kbd>Control</kbd>+<kbd>Shift</kbd>+<kbd>P</kbd></td>
    </tr>
    <tr>
      <td>Toggle the <b><a href="/microsoft-edge/devtools-guide-chromium/chromium-devtools/ui#drawer">Drawer</a></b></td>
    ...
    <tr>
      <td>Opens the <b>Search</b> tab in the <b><a href="/microsoft-edge/devtools-guide-chromium/chromium-devtools/ui#drawer">Drawer</a></b>, which lets you search for text across all loaded resources</td>
    ...
    <tr>
      <td>Run snippet</td>
      <td>Press <kbd>Command</kbd>+<kbd>O</kbd> to open the <b><a href="/microsoft-edge/devtools-guide-chromium/chromium-devtools/ui#command-menu">Command Menu</a></b>, type <kbd>!</kbd> followed by the name of the script, then press <kbd>Enter</kbd></td>
      <td>Press <kbd>Control</kbd>+<kbd>O</kbd> to open the <b><a href="/microsoft-edge/devtools-guide-chromium/chromium-devtools/ui#command-menu">Command Menu</a></b>, type <kbd>!</kbd> followed by the name of the script, then press <kbd>Enter</kbd></td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Press <kbd>Command</kbd>+<kbd>O</kbd> to open the <b><a href="/microsoft-edge/devtools-guide-chromium/chromium-devtools/ui#command-menu">Command Menu</a></b>, type <kbd>:</kbd> followed by the line number, then press <kbd>Enter</kbd></td>
      <td>Press <kbd>Control</kbd>+<kbd>O</kbd> to open the <b><a href="/microsoft-edge/devtools-guide-chromium/chromium-devtools/ui#command-menu">Command Menu</a></b>, type <kbd>:</kbd> followed the line number, then press <kbd>Enter</kbd></td>
    </tr>
    <tr>
      <td>Jump to a column of the currently-open file (for example line 5, column 9)</td>
      <td>Press <kbd>Command</kbd>+<kbd>O</kbd> to open the <b><a href="/microsoft-edge/devtools-guide-chromium/chromium-devtools/ui#command-menu">Command Menu</a></b>, type <kbd>:</kbd>, then the line number, then another <kbd>:</kbd>, then the column number, then press <kbd>Enter</kbd></td>
      <td>Press <kbd>Control</kbd>+<kbd>O</kbd> to open the <b><a href="/microsoft-edge/devtools-guide-chromium/chromium-devtools/ui#command-menu">Command Menu</a></b>, type <kbd>:</kbd>, then the line number, then another <kbd>:</kbd>, then the column number, then press <kbd>Enter</kbd></td>
    </tr>
    <tr>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>Add or remove a <a href="/microsoft-edge/devtools-guide-chromium/chromium-devtools/javascript/breakpoints#loc">line-of-code breakpoint</a></td>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <img class="cdt-inl" src="/microsoft-edge/devtools-guide-chromium/chromium-devtools/images/expand.png"/>
      </td>
      <td>
        Hold <kbd>Alt</kbd> then click <b>Expand</b>
        <img class="cdt-inl" src="/microsoft-edge/devtools-guide-chromium/chromium-devtools/images/expand.png"/>
