...
This tutorial teaches you how to use the **Console** in Microsoft Edge DevTools.

<figure>
  <img src="/microsoft-edge/devtools-guide-chromium/chromium-devtools/images/panels/console.msft.png"
       alt="The Console.">
...
[API]: /microsoft-edge/devtools-guide-chromium/chromium-devtools/console/console-reference

1. Press <kbd>Command</kbd>+<kbd>Option</kbd>+<kbd>J</kbd> (Mac) or
   <kbd>Control</kbd>+<kbd>Shift</kbd>+<kbd>J</kbd> (Windows, Linux, Microsoft Edge OS) to open the
   **Console**, right here on this very page.

     <figure>
       <img src="images/open.msft.png"
...
1. Click **Expand** ![The Expand icon][expand]{:.inline-icon} next to `warn` and `error` to see
   ...
   bottom of the stack called the one above it.
     ...
     <figure>
       <img src="images/error-stack.msft.png"
...
[expand]: /microsoft-edge/devtools-guide-chromium/chromium-devtools/images/shared/expand.png
...
1. Click **Log Numbers**. The **Console** prints out whether each number from 1 to 1000 is prime.
   ...
   filtering.
     ...
     {% framebox width="auto" height="auto" enable_widgets="true" %}
       {% includecode content_path="microsoft-edge/devtools-guide-chromium/chromium-devtools/console/_code/primes.html" %}
     {% endframebox %}
...
[sidebar]: /microsoft-edge/devtools-guide-chromium/chromium-devtools/images/shared/show-console-sidebar.png
...
1. Click **333 Warnings**. DevTools now only shows messages that were logged with
   ...
   are filtering along 2 dimensions right now.
     ...
     <figure>
       <img src="images/sidebar-regex.msft.png"
...
1. Type `document.getElementById('changeMyText').textContent = 'Hello'` in the **Console**
   ...
   `Change My Text` to `Hello`. It probably won't work. You'll find out why next.
     ...
     <figure>
       <img src="images/change-fail.msft.png"
...
1. Right-click **Change My Text** and select **Inspect**. DevTools jumps to the **Elements**
   panel and highlights the element in the **DOM Tree**.
     ...
     <figure>
       <img src="images/inspect-button.msft.png"
...
1. Press <kbd>Escape</kbd>. The **Console** opens up at the bottom of the **Elements** panel.
   ...
   in the **DOM Tree**, and that button is embedded in an `iframe`.
     ...
     <figure>
       <img src="images/iframe-context.msft.png"
...
[CAPI]: /microsoft-edge/devtools-guide-chromium/chromium-devtools/console/console-reference
...
[Debugging]: /microsoft-edge/devtools-guide-chromium/chromium-devtools/javascript/
...
[CLAPI]: /microsoft-edge/devtools-guide-chromium/chromium-devtools/console/command-line-reference
