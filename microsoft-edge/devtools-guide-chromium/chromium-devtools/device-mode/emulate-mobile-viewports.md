...
description: Microsoft Edge DevTools' Device Mode lets you mimic how your development  site will look in production on a range of devices.
robots: noindex
...
The updated Device Mode (since Microsoft Edge 49) is an integral part of the now-mobile-first DevTools and 
...
<aside class="warning">
  ...
  <a href="/microsoft-edge/devtools-guide-chromium/chromium-devtools/device-mode/#responsive">Response Viewport Mode</a>
  and
  <a href="/microsoft-edge/devtools-guide-chromium/chromium-devtools/device-mode/#device">Mobile Device Viewport Mode</a>.
</aside>
...
<div class="wf-devtools-flex">
  ...
  <div class="wf-devtools-flex-third">
    <img src="imgs/select-device.msft.png" alt="select a device">
  </div>
</div>
...
<aside class="warning">
  <b>This page is deprecated</b>. See
  <a href="/microsoft-edge/devtools-guide-chromium/chromium-devtools/device-mode/#custom">Add a custom mobile device</a>.
</aside>
...
<div class="wf-devtools-flex">
  ...
  <div class="wf-devtools-flex-half">
    <img src="imgs/custom-device.msft.png" alt="select a device">
  </div>
</div>
...
<aside class="warning">
  <b>This page is deprecated</b>. See
  <a href="/microsoft-edge/devtools-guide-chromium/chromium-devtools/device-mode/#orientation">Set orientation</a>.
</aside>
...
<div class="wf-devtools-flex">
  <div>
    ...
    <ul>
      ...
      <li>With Microsoft Edge navigation bar</li>
      <li>With opened keyboard</li>
    </ul>
  </div>
  <div class="wf-devtools-flex-third">
    <img src="imgs/change-device-state.msft.png" alt="Change the Device UI">
  </div>
</div>
...
<div class="wf-devtools-flex">
  ...
  <div class="wf-devtools-flex-third">
    <img src="imgs/zoom-to-fit.msft.png" alt="Zoom to Fit">
  </div>
</div>
...
<div class="wf-devtools-flex">
  ...
  <div class="wf-devtools-flex-third">
    <img src="imgs/device-mode-dotmenu.msft.png" alt="Device Mode Settings">
  </div>
</div>
...
<aside class="warning">
  <b>This page is deprecated</b>. See
  <a href="/microsoft-edge/devtools-guide-chromium/chromium-devtools/device-mode/#queries">Show media queries</a>.
</aside>
...
<aside class="warning">
  <b>This page is deprecated</b>. See
  <a href="/microsoft-edge/devtools-guide-chromium/chromium-devtools/device-mode/#rulers">Show rulers</a>.
</aside>
...
[nc]: /microsoft-edge/devtools-guide-chromium/chromium-devtools/network-performance/reference#network-conditions
...
* **Browser functionality**
    ...
    * MathML is not supported in Microsoft Edge, but is supported on iOS 7 devices.
    * [HLS playback](https://en.wikipedia.org/wiki/HTTP_Live_Streaming) (HTTP Live Streaming for 
		video) is not supported while emulating, but is supported natively on Android Microsoft Edge and iOS.
...
[Remote Debugging](/microsoft-edge/devtools-guide-chromium/chromium-devtools/debug/remote-debugging) 
