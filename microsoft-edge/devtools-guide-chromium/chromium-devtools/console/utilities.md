...
description: A reference of convenience functions available in the Microsoft Edge DevTools Console.
...
Warning: These functions only work when you call them from the Microsoft Edge DevTools Console. They won't work
if you try to call them in your scripts.

Looking for `console.log()`, `console.error()`, and the rest of the `console.*` functions?
See [Console API Reference](/microsoft-edge/devtools-guide-chromium/chromium-devtools/console/api).
...
see the
[`console.dir()`](/microsoft-edge/devtools-guide-chromium/chromium-devtools/debug/console/console-reference#console.dir(object))
...
(See also
[Speed Up JavaScript Execution](/microsoft-edge/devtools-guide-chromium/chromium-devtools/rendering-tools/js-execution).)
