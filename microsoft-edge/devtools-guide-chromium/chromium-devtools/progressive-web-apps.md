...
You can test out this feature with the [Microsoft I/O 2016 progressive web
...
Microsoft Edge to display the "add this site to your shelf" banner, which is the
...
[shelf]: images/io.png
[remote debugging]: /microsoft-edge/devtools-guide-chromium/chromium-devtools/debug/remote-debugging/remote-debugging
...
* The **Clients** line tells you the origin that the service worker is scoped
  ...
  **show all** checkbox. When that checkbox is enabled, all registered service
  ...
  worker that is running in a different tab, Microsoft Edge focuses on that tab.
...
* [Clear
  Storage](/microsoft-edge/devtools-guide-chromium/chromium-devtools/iterate/manage-data/local-storage#clear-storage)
...
* [Inspect page resources](/microsoft-edge/devtools-guide-chromium/chromium-devtools/iterate/manage-data/page-resources)
* [Inspect and manage local storage and
  caches](/microsoft-edge/devtools-guide-chromium/chromium-devtools/iterate/manage-data/local-storage)
